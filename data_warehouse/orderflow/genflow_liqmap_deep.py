...
def main():
    ...
    # ls_ratio GLEBOKI z Binance metrics (2 lata, corr +0.996 z Coinalyze) zamiast 3-mies Coinalyze.
    # JEDYNA zmiana vs genflow_liqmap.py: zrodlo/glebokosc ls_ratio. Reszta identyczna.
    ls=pd.read_parquet(WH/"derivatives/ls_ratio_deep/BTC.parquet"); ls["timestamp"]=pd.to_datetime(ls["timestamp"])
